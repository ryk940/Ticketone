      ...
      <div class="card-body">
        ...
        <table class="table table-light table-sm table-hover">
          ...
          <tr>
            ...
            <td><c:out value="${ticket.pay_amount}원"/></td>
          </tr>
      	...
      	<div style="text-align: center;">
	        <span style="margin: 10px;"><a href="index">메인화면으로 이동</a></span>
	  		<span style="margin: 10px;"><a href="userTicketList?user_id=${sessionScope.loginUser.user_id}">예매내역 확인</a></span>
    	</div>
    </span>
  </div>
